...
elseif ($action == 'order_list')
{
    ...
    foreach ($orders as $k=>$v){
		$sql="select o.goods_id,o.goods_name,o.goods_number,o.goods_price,g.goods_img from ecs_order_goods as o left join ecs_goods as g on g.goods_id=o.goods_id where order_id=".$v['order_id']; 
