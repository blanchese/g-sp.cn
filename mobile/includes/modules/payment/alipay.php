...
class alipay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $button = '<input type="button" class="uo-Ibtn" style="border:0px;" onclick="window.open(\'https://mapi.alipay.com/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5\')" value="立即支付" />';
