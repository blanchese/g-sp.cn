...
if (!$smarty->is_cached('product_view.html', $cache_id))
{
    ...
    /* 获得商品的信息 */
    $sql="select * from en_goods where goods_id=".$goods_id;
    $goods=$db->getRow($sql);
...
$sql="select goods_id,goods_name,goods_img,shop_price,market_price from en_goods where is_hot=1 and cat_id=".$goods['cat_id']." order by click_count desc limit 10";
